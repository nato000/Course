<template>
  <center v-if="show == true">
    <div v-for="item in flights" v-bind:key="item.id">
      ...
      <div class="search_panel active">
        ...
        >
          ...
          <button class="button search_button" @click="q">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="offers_content">
              <div class="offers_price" {{item.price}}>
                price:{{ this.item.price }} /// $70<span>per night</span>
              </div>
