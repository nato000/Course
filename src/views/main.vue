                  ...
                  <div class="col-lg-6">
                    <div class="offers_image_container">
                      ...
                      <div class="offer_name">
                        <a href="#">{{ item.cityFrom }} -> {{ item.cityTo }}</a>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="offers_content">
                      ...
                      <ul class="offer_text">
                        <li>
                          Arrival date - {{ item.local_departure.slice(0, 10) }}
                        </li>
                        <li>
                          Arrival time -
                          {{ item.local_departure.slice(11, 19) }}
                        </li>
                      </ul>
                      <h5>Local departure:</h5>
                      <ul class="offer_text">
                        <li class="fas fa-calendar-alt">
                          Departure date -
                          {{ item.local_arrival.slice(0, 10) }}
                        </li>
                        <li>
                          Departure time -
                          {{ item.local_arrival.slice(11, 19) }}
                        </li>
                      </ul>
                      <h5>Fly duration:</h5>
                      <p class="offers_text">
                      ...
                      <p class="offers_text">
                        <img
                          :src="
                            `https://images.kiwi.com/airlines/32x32/${item.airlines[0]}.png`
                          "
                          alt=""
                        />
                      </p>
                      <p class="offers_text">
                        Availability: {{ item.availability.seats }} seat(s)
                      </p>
                      <p class="offers_text"></p>
                      <table>
                        <tbody>
                      ...
                      <div class="button search_button">
                        <a v-bind:href="item.deep_link" target="_blank">Buy</a>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      axios
        .get(
          "https://api.skypicker.com/locations?term=" +
            this.city1 +
            "&locale=en-US&location_types=city&limit=10&active_only=true&sort=name"
        )
        .then((response) => {
          ...
          axios
            ...
            .then((response) => {
              ...
              axios
                .get(
                  "https://tequila-api.kiwi.com/v2/search?fly_from=" +
                    cityFrom +
                    "&fly_to=" +
                    cityTo +
                    this.swType +
